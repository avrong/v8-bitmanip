...
void AssemblerRISCVZbb::rol(Register rd, Register rs1, Register rs2) {
...
void AssemblerRISCVZbb::orcb(Register rd, Register rs) {
...
void AssemblerRISCVZbb::rev8(Register rd, Register rs) {
  GenInstrI(0b101, OP_IMM, rd, rs,  0b011010011000);
}
#endif

#ifdef V8_TARGET_ARCH_RISCV64
void AssemblerRISCVZbb::rolw(Register rd, Register rs1, Register rs2) {
...
void AssemblerRISCVZbb::roriw(Register rd, Register rs1, uint8_t shamt) {
  DCHECK(is_uint5(shamt));
  GenInstrI(0b101, OP_IMM_32, rd, rs1,  (0b0110000 << kFunct7Shift) | shamt);
}

void AssemblerRISCVZbb::rorw(Register rd, Register rs1, Register rs2) {
